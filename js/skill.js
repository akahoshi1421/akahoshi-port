...
const SKILLDISCRIPT = [
    [
        {
            title: "Python",
            discript: "大学で学びました。データ解析、WEB開発(サーバサイド)、ツール作成等幅広い範囲で利用しています。"
        },
        {
            title: "JavaScript",
        ...
        {
            title: "HTML+CSS",
            discript: "大学で基礎的な範囲を学びました。最近では独学でCSSアニメーションやSass等発展的な範囲を勉強し、当サイトも学んだ技術をふんだんに使っています。"
        }
    ],
    [
        {
            title: "PHP",
            discript: "独学で学びました。WEB開発全般に興味があるので、バックエンドを勉強するために学習を行いました。"
        },
        {
            title: "Ruby",
            discript: "独学で学びました。「Ruby on Rails」(後述)を勉強するため学習を行いました。"
        },
        {
            title: "C",
            discript: "大学で学びました。アルゴリズムやOSの勉強、組み込みプログラミング等の用途に使用しています。"
        }
    ],
    [
        {
            title: "C#(Unity)",
            discript: "高校の時軽く学びました。大学でも講義で利用したので、軽くではありますが触れます。"
        },
        {
            title: "Django",
